...
<section id="table-layout" class="mb-42">
  ...
  <div class="v37-table-grid">
    ...
    <div class="release-text-box" style="grid-area: box1">
      <h3>At a glance</h3>
      <div class="prose">
        With the brand new <a href="/docs/reference/panel/sections/pages#layout__table-layout">table layout</a> for pages and files sections, you get a great overview of your content. Customize the columns you want to show to present exactly the data you&nbsp;need.
      </div>
    </div>
